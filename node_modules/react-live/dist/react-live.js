(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('prop-types'), require('react-simple-code-editor'), require('prism-react-renderer'), require('create-react-context'), require('buble'), require('core-js/fn/object/assign')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', 'react-simple-code-editor', 'prism-react-renderer', 'create-react-context', 'buble', 'core-js/fn/object/assign'], factory) :
	(factory((global.ReactLive = {}),global.React,global.propTypes,global.Editor,global.Prism,global.createContext,global.Buble,global.assign));
}(this, (function (exports,React,propTypes,Editor,Highlight,createContext,buble,assign) { 'use strict';
